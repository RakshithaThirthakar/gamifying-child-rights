// This script is optional if you want to add more interactive behavior to the octopus
document.addEventListener('DOMContentLoaded', () => {
    const octopus = document.querySelector('.octopus');
    // Add any additional JavaScript for the octopus animation here
});
...
function endGame(who) {
    ...
    var playerWinMessages = [
        "YOU WON! <br> Children Rights <br> Right to Life, Survival, and Development: <br> You have the right to life and to grow to your full potential.",
        "YOU WON! <br> Children Rights <br>  Right to Non-Discrimination: <br> You have the right to be treated fairly no matter who you are.",
        "YOU WON! <br> Children Rights <br> Right to be Heard: <br> You have the right to have your opinions listened to and taken seriously.",
        "YOU WON! <br> Children Rights <br> Right to Identity: <br> You have the right to an identity, which includes a name",
        "YOU WON! <br> Children Rights <br> Right to Education: <br> You have the right to go to school and learn.",
        "YOU WON! <br> Children Rights <br> Right to Protection from Violence: <br> You have the right to be safe from harm.",
        "YOU WON! <br> Children Rights <br> Right to Health and Health Services: <br> You have the right to get good care when you’re sick."
    ];

    if (who == player) {
        // Randomly select a message from the list
        var messageIndex = Math.floor(Math.random() * playerWinMessages.length);
        var winMessage = playerWinMessages[messageIndex];
        announceWinner(winMessage);
